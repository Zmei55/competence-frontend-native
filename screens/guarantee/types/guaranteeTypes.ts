...
export type TCompetaConfirmationRegistered = {
	...
	statusCompetaConfirmation: typeof CONFIRMED | typeof NOT_CONFIRMED | typeof REJECTED;
	requestTime: Dayjs;
	confirmedTime: Dayjs;
};
...
export type TNewCompetaConfirmationUnregistered = Omit<TCompetaConfirmationUnregistered, 'id'>;
